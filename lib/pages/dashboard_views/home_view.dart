...
import 'package:laundry_flutter/pages/search_by_city_page.dart';
import 'package:laundry_flutter/providers/home_provider.dart';
...
class _HomeViewState extends ConsumerState<HomeView> {
    ...
    PromoDataSource.readLimit().then((value) {
      ...
      value.fold((failure) {
        switch (failure.runtimeType) {
          case ServerFailure:
            setHomePromoStatus(ref, 'Server Failure');
            break;
          case NotFoundFailure:
            setHomePromoStatus(ref, 'Not Found Failure');
            break;
          case ForbiddenFailure:
            setHomePromoStatus(ref, 'Forbbiden Failure');
            break;
          case BadRequestFailure:
            setHomePromoStatus(ref, 'Bad Request Failure');
            break;
          case InvalidInputFailure:
            setHomePromoStatus(ref, 'Invalid Input Failure');
            break;
          case UnauthorisedFailure:
            setHomePromoStatus(ref, 'Unauthorized Failure');
            break;
          default:
        ...
        ref.read(homePromoListProvider.notifier).setData(promo);
      });
    });
  }
  getRecommendation() {
      ...
      value.fold((failure) {
        switch (failure.runtimeType) {
          case ServerFailure:
            ...
            break;
          case NotFoundFailure:
            setHomeRecommendationStatus(ref, 'Not Found Error');
            break;
          case ForbiddenFailure:
            setHomeRecommendationStatus(ref, 'Forbidden Error');
            break;
          case BadRequestFailure:
            setHomeRecommendationStatus(ref, 'Bad Request Error');
            break;
          case InvalidInputFailure:
            setHomeRecommendationStatus(ref, 'Invalid Input Error');
            break;
          case UnauthorisedFailure:
            setHomeRecommendationStatus(ref, 'Unauthorized Error');
            break;
          default:
        ...
        List data = result['data'];
        List<ShopModel> shop = data.map((e) => ShopModel.fromJson(e)).toList();
        ref.read(homeRecommendationListProvider.notifier).setData(shop);
      });
    });
  }
        ...
        children: [
          Text(
            ...
            style: GoogleFonts.poppins(
                fontSize: 28, fontWeight: FontWeight.w500, height: 1),
          ),
          DView.spaceHeight(4),
          Text(
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            IconButton(onPressed: () => gotoSearchCity(),
  ...
  Consumer promo() {
    ...
    return Consumer(builder: (_, wiRef, __){
        ...
        return Column(
          children: [
            Padding(padding: const EdgeInsets.fromLTRB(30, 0, 30, 16),
            child: Row(
            ...
            if(list.isNotEmpty) AspectRatio(aspectRatio: 16/9 ,
    ...
    return Consumer(builder: (_, wiRef,__){
      ...
      return Column(
        children: [
          ...
          if (list.isEmpty) Padding(
            padding: const EdgeInsets.symmetric(horizontal: 30),
            child: const ErrorBackgorud(ratio: 1.2, message: 'No Recommendation Yet'),
          ),
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index){
                  ...
                  return GestureDetector(
                    onTap: (){},
                    child: Container(
                      margin: EdgeInsets.fromLTRB(index == 0 ? 30 : 10,
                          0,
